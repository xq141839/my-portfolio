...
const PROFILE = {
  ...
  lab: "CVIP Lab",
  email: "qing.xu@nottingham.edu.cn",
  ...
  about: (
    <>
      I'm a Ph.D. Candidate in the School of Computer Science at University of Nottingham, supervised by <a href="https://research.nottingham.edu.cn/en/persons/xiangjian-he/" className="font-semibold text-slate-900 hover:underline hover:text-indigo-800 transition-colors">Prof. Xiangjian He</a>. 
...
const SectionTitle = ({ children, icon: Icon }) => (
  <div className="flex items-center gap-3 mb-8 group">
    <div className="p-2 bg-indigo-100 rounded-lg text-slate-900 group-hover:scale-110 transition-transform duration-300">
      {Icon && <Icon size={24} />}
    </div>
...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-600 selection:bg-indigo-100 selection:text-blue-700">
            ...
            <div className="flex-1 space-y-6 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start gap-4 pt-2">
                ...
                <div className="flex gap-2">
                  <a href={PROFILE.scholarUrl} className="p-3 bg-white border border-slate-200 rounded-lg hover:border-indigo-300 hover:text-slate-900 transition-colors shadow-sm">
                    <BookOpen size={20} />
                  </a>
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3 text-sm font-medium mt-1">
                    <span className="text-blue-700">{pub.venue}</span>
                  ...
                  <div className="flex gap-3 mt-4 pt-4 border-t border-slate-50">
                    {pub.links.pdf && (
                      <a href={pub.links.pdf} className="flex items-center gap-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 transition-colors">
                        <FileText size={14} /> PDF
                      </a>
                    )}
                    {pub.links.code && (
                      <a href={pub.links.code} className="flex items-center gap-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 transition-colors">
                        <Github size={14} /> Code
                      </a>
                    )}
                    {pub.links.project && (
                      <a href={pub.links.project} className="flex items-center gap-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 transition-colors">
